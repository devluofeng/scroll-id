    ...
    <>
      ...
      <FaqContainer>
        ...
        <Section question="Can I use an ENS name to point to my website?">
          ...
          (e.g. matoken.arb.link or matoken.arb.limo).
          <br />
          ...
          your contenthash. See the source code of depositcontract.arb.limo as
          an example.
        </Section>
        ...
        <Section question="How much does it cost to register a .arb name?">
          Currently, registration costs are set at the following prices:
          <ul>
            <li>5+ character .arb names: $5 in ETH per year.</li>
            <li>4 character .arb names: $160 in ETH per year.</li>
            <li>3 character .arb names $640 in ETH per year.</li>
          </ul>
        ...
        <Section question="How much gas does it cost to register and extend registration?">
          ...
          (register, set resolver and set arb address) hence the gas cost is
          relatively expensive.
        </Section>

        <Section question="Can I register names other than .arb?">
        ...
        <Section question="What is the difference between the Registrant and Controller?">
          ...
          behalf.
          <br />
          The Registrant only exists on ".arb" names and it allows you to change
        ...
        <Section question="How do I unregister my name?">
          ...
          you cannot do so on ".arb" addresses. Because ".arb" names are
        ...
        <Section question="How do I transfer my name?">
          For a ".arb" name, transfer both the Registrant and the Controller to
          the new Ethereum account. Since ".arb" names are ERC721 compliant
