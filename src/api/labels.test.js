...
describe('saveName', () => {
  it('should save all labels to localStorage (2)', () => {
    const name = 'vitalik.scroll'
    const nameArray = ['vitalik', 'scroll']
    const hashes = [
  ...
  it('should save all labels to localStorage (3)', () => {
    const name = 'awesome.vitalik.scroll'
    const nameArray = ['awesome', 'vitalik', 'scroll']
    const hashes = [
...
describe('parseName', () => {
  ...
  it('should parse all the labels (3) and return the encoded string', () => {
    const name = `0x${blahblahHash}.vitalik.scroll`
    const encodedName = `[${blahblahHash}].vitalik.scroll`
    const parsedName = parseName(name)
